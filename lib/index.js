    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function getRewardAddresses() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getRewardAddressesHex()];
                        case 1: return [2 /*return*/, (_a.sent()).map(function (hexAddress) {
                                var _a;
                                return (_a = S.RewardAddress.from_address(S.Address.from_bytes(Buffer.from(hexAddress, 'hex')))) === null || _a === void 0 ? void 0 : _a.to_address().to_bech32();
                            })];
                    }
                });
            });
        }
        function getRewardAddressesHex() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Nami.getRewardAddresses()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
                ...
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        ...
                        case 1:
                            ...
                            _j = (_h = Buffer).from;
                            return [4 /*yield*/, getRewardAddressesHex()];
                        case 2:
                            stakeKeyHash = _e.apply(_d, [_g.apply(_f, [_j.apply(_h, [(_l.sent())[0],
                                        'hex'])])]).payment_cred().to_keyhash().to_bytes();
                            _k = getDelegation;
                            return [4 /*yield*/, getRewardAddresses()];
                        case 3: return [4 /*yield*/, _k.apply(void 0, [(_l.sent())[0]])];
                        case 4:
                            delegation = _l.sent();
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, {
                            ...
                            getRewardAddressesHex: getRewardAddressesHex,
